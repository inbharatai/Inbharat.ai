...
const copy: Record<string, string> = {
  ...
  inBharatCreative: 'Creative',
  inBharatCreativeDesc: 'Image generation, ideas, and visual content.',
  inBharatCoder: 'Coder',
  ...
  inBharatWhy2: 'Multiple intelligence modes—research, creative, coder, browser.',
...
const inBharatCapabilitiesList: { key: string; icon: React.ElementType }[] = [
  ...
  { key: 'inBharatCreative', icon: Sparkles },
