...
import { Activity, Globe, GitBranch, AlertTriangle, BarChart3, Settings as SettingsIcon, ShieldAlert, Wallet, Brain, Inbox as InboxIcon, GraduationCap, Target, Bot, Share2 } from "lucide-react";
...
const NAV: { to: string; label: string; icon: React.ComponentType<{ size?: number }> }[] = [
  ...
  { to: "syndication", label: "Syndication", icon: Share2 },
