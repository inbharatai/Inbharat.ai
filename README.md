...
- **15-product ecosystem** — InBharat AI + 14 sister products organized into 6 verticals (InBharat Core AI · Agent Ops & Security · Growth & Publishing · Consumer & Culture · Education & Career · Health & Public Service) on the landing page: KathaKitaab, JAK Swarm, Agent Arcade, SocialFlow, Sahayaak AI, Phoring, UniBot, UniAssist.ai, TestsPrep.in, UnoOne, OpenClawFix, Sahayaak Seva, SwasthyaScore AI, and JAK Shield
